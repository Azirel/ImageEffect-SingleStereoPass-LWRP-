...
namespace UnityEngine.Rendering.LWRP
{
	...
	{
		public delegate void OnPostProcessEventType(CommandBuffer cmd, ref CameraData data, RenderTextureDescriptor sourceDescriptor, RenderTargetIdentifier sourceIdentifier, RenderTargetIdentifier destinationIdentifier, bool opaqOnly, bool flip);

		public static event OnPostProcessEventType OnPostProcessEvent;
		...
		public void RenderPostProcessing(CommandBuffer cmd, ref CameraData cameraData, RenderTextureDescriptor sourceDescriptor, RenderTargetIdentifier source, RenderTargetIdentifier destination, bool opaqueOnly, bool flip)
		{
			...
			OnPostProcessEvent?.Invoke(cmd, ref cameraData, sourceDescriptor, source, destination, opaqueOnly, flip);
